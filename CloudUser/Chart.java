...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(ClientScreen.propose_time,"Propose Encryption Time","Propose Encryption Time");
	localDefaultCategoryDataset.addValue(ClientScreen.existing_time,"Existing AES Encryption Time","Existing AES Encryption Time");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Algorithm Name", "Execution Time (Milli.Sec)", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
